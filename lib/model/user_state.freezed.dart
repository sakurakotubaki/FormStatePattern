...
abstract class $PersonCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic gender, String kana, int password});
}
...
class __$$PersonImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$PersonImpl(
      gender: freezed == gender ? _value.gender! : gender,
      kana: null == kana
          ? _value.kana
          : kana // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$PersonImpl with DiagnosticableTreeMixin implements _Person {
  const _$PersonImpl({this.gender = Gender, this.kana = '', this.password = 0});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Person(gender: $gender, kana: $kana, password: $password)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(gender), kana, password);
...
abstract class _Person implements Person {
  const factory _Person(
      {final dynamic gender,
      final String kana,
      final int password}) = _$PersonImpl;
